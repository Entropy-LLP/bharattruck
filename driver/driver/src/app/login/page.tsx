        ...
        <div className="rounded-2xl border border-border bg-card p-6 shadow-2xl shadow-black/40">
          ...
          <details className="group mt-6 border-t border-border pt-5">
            ...
            <div className="mt-4 space-y-3">
              ...
              />
              <button
                onClick={() => handleLogin('mock-jwt-driver-token', '')}
                className="h-10 w-full rounded-xl border border-border bg-secondary text-xs font-medium text-foreground/80 transition hover:border-blue-600/40 hover:text-foreground"
              >
                Instant mock driver sign-in
              </button>
            </div>
          </details>
        </div>
