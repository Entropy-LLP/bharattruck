/**
 * Maps helpers for the driver navigation view.
 *
 ...
 *  - Per decision D-013 this module is COPIED into each app (driver/, shipper/,
 *    fleet/), not shared as a package. Keep the copies in sync BY HAND.
 */
