...
const MOCK_BOOKINGS = [
  {
    id: 'bk_001',
    source_address: '45 MG Road, Mumbai',
    destination_address: '12 Brigade Road, Bengaluru',
    load_type: 'fragile',
    weight_kg: 8500,
    quoted_price: 87200,
  ...
  {
    id: 'bk_002',
    source_address: 'Phase 2, MIDC, Pune',
  ...
  {
    id: 'bk_003',
    source_address: 'Guindy Industrial Estate, Chennai',
    destination_address: 'Jeedimetla, Hyderabad',
  ...
  {
    id: 'bk_004',
    source_address: 'Peenya Industrial Area, Bengaluru',
    destination_address: 'Ambattur, Chennai',
    load_type: 'hazardous',
    weight_kg: 22000,
    quoted_price: 195000,
  ...
  {
    id: 'bk_005',
    source_address: 'Surat Textile Market, Surat',
    destination_address: 'Ludhiana Apparel Hub, Ludhiana',
    load_type: 'general',
    weight_kg: 12000,
    quoted_price: 67400,
  ...
  {
    id: 'bk_006',
    source_address: 'Kandla Port, Gujarat',
    destination_address: 'Rewari FMCG Hub, Haryana',
    load_type: 'general',
    weight_kg: 28000,
    quoted_price: 218000,
...
const STATS = [
  {
    label: 'Total Bookings', value: '6', sub: 'All time',
    icon: '📦',
  ...
  {
    label: 'In Transit', value: '1', sub: 'Active now',
    icon: '🚛',
  ...
  {
    label: 'Total Spent', value: '₹7.49L', sub: 'Freight cost',
    icon: '💰',
  ...
  {
    label: 'Avg. Quote', value: '₹1.25L', sub: 'Per booking',
    icon: '📊',
...
function BookingCard({ booking, index }: { booking: typeof MOCK_BOOKINGS[0]; index: number }) {
