          ...
          <details className="group mt-6 border-t border-border pt-5">
            ...
            <div className="mt-4 space-y-3">
              ...
              <button
                ...
                className="h-10 w-full rounded-xl border border-border bg-secondary text-xs font-medium text-foreground/85 transition hover:border-blue-600/40 hover:text-foreground disabled:opacity-40"
              >
                Use Token
              </button>
            </div>
