 ...
 */
export declare function resolveFleetOwnerByUserId(supabase: SupabaseClient, userId: string): Promise<FleetOwnerRef | null>;
/**
 ...
 */
export declare function getLiveFleetAffiliation(supabase: SupabaseClient, driverId: string): Promise<FleetAffiliation | null>;
/**
 ...
 */
export declare function isFleetAffiliatedDriver(supabase: SupabaseClient, driverId: string): Promise<boolean>;
/**
 ...
 */
export declare function canFleetAccessBooking(supabase: SupabaseClient, fleetOwnerId: string, booking: FleetAccessibleBooking): Promise<boolean>;
